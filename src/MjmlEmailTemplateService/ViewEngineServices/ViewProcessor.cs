...
using MjmlEmailTemplateService.Models;

namespace MjmlEmailTemplateService.ViewEngineServices
{
    public sealed class ViewProcessor : Controller, IViewProcessor
    {
        ...
        public ViewProcessor(IRazorViewEngine viewEngine, ITempDataProvider tempDataProvider, INodeServices nodeServices)
        {
